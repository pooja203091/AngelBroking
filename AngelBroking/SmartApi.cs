...
{  
    public class SmartApi
    {
        ...
        /*User Calls*/
        public OutputBaseClass GenerateSession(string clientcode, string password,int totp) //public OutputBaseClass GenerateSession(string clientcode, string password)
        {
